...
import {Body, Card, CardItem, Container, Tab, Tabs, Text} from 'native-base';
        ...
        return (
            <Container style={styles.background_general}>
                ...
                <Tabs tabBarUnderlineStyle={{backgroundColor: '#f39c12'}} tabContainerStyle={{elevation: 0}}>
                    ...
                    <Tab heading={Strings.ST5} tabStyle={styles.tabs_diets} activeTabStyle={styles.activetabs_diets}
                                                    ...
                                                    <Card style={{
                                                        ...
                                                        <Grid style={{
                                                            ...
                                                            <Col style={{
                                                                ...
                                                                <TouchableOpacity
                                                                    onPress={this.saveQuotes.bind(this, item.quote_id, item.quote_title, user.uid)}
                                                                    activeOpacity={1}>
                                                                    <Text style={{fontSize: 14, color: '#666'}}>
                                                                        <Ionicons name="md-star" style={{
                                                                            fontSize: 14,
                                                                            color: '#f39c12'
                                                                        }}/> {Strings.ST57}</Text>
                                                                </TouchableOpacity>
                                                            ...
                                                            <Col style={{
                                                                ...
                                                                <TouchableOpacity
                                                                    onPress={this.onClickShare.bind(this, item.quote_title)}
                                                                    activeOpacity={1}>
                                                                    <Text style={{fontSize: 14, color: '#666'}}>
                                                                        <Ionicons name="md-share" style={{
                                                                            fontSize: 14,
                                                                            color: '#f39c12'
                                                                        }}/> {Strings.ST58}</Text>
                                                                </TouchableOpacity>
                    ...
                    <Tab heading={Strings.ST56} tabStyle={styles.tabs_diets} activeTabStyle={styles.activetabs_diets}
                         textStyle={styles.tabs_text_diets} activeTextStyle={styles.activetabs_text_diets}>
